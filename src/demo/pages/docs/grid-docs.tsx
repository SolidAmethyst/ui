  ...
  return (
    <article style={docsStyles.article()}>
      ...
      <section style={docsStyles.section()}>
        ...
        <CodeHighlight code={gridSnippets.imports} />
      </section>
      {/* Basic Usage */}
      <section style={docsStyles.section()}>
        <Typography variant="h3" as="h2">
          ...
          preview={
            <div style={docsStyles.previewContainer()}>
              <div style={{ width: "100%" }}>
                ...
                <Typography variant="small" style={{ "margin-bottom": "16px" }}>
      ...
      <section style={docsStyles.section()}>
        ...
        <Typography variant="small" style={{ "margin-top": "8px" }}>
        ...
        <Typography variant="h4" as="h3" style={{ "margin-top": "32px" }}>
        ...
        >
          ...
          >
            ...
            <input
              ...
              onInput={(e) =>
                setSidebarAmount2(parseInt(e.currentTarget.value))
              }
              style={{
                flex: "1",
                cursor: "pointer",
      ...
      <section style={docsStyles.section()}>
        ...
        <CodeHighlight code={gridSnippets.customization} />
        <Typography variant="body">
        ...
        <CodeHighlight code={gridSnippets.customizationPreserveArea} />
      </section>
    </article>
  );
};
