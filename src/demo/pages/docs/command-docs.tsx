...
export const CommandDocs: Component = () => {
  return (
    <article style={docsStyles.article()}>
      <Typography variant="h1">Command</Typography>
      ...
      <section style={docsStyles.section()}>
        ...
        <CodeHighlight code={commandSnippets.customization} />
        <Typography variant="body">
