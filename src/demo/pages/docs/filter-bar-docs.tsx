	...
	return (
		<article style={docsStyles.article(theme())}>
			...
			<Typography variant='body' isDark={props.isDark()}>
				FilterPanel is a modal-based filter component with sections for file types,
				visibility, and size filtering. It provides a structured approach to filtering
				with clear sections and a reset button.
			</Typography>
