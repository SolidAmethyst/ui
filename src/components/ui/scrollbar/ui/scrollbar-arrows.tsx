  ...
  return (
    <>
      {props.direction === "vertical" ? (
        <>
          <button
            class={`scrollbar-arrow scrollbar-arrow-up ${
              !props.canScrollUp ? "disabled" : ""
            }`}
          ...
          <button
            class={`scrollbar-arrow scrollbar-arrow-down ${
              !props.canScrollDown ? "disabled" : ""
            }`}
        ...
        <>
          <button
            class={`scrollbar-arrow scrollbar-arrow-left ${
              !props.canScrollUp ? "disabled" : ""
            }`}
            disabled={!props.canScrollUp}
            onClick={(e) => handleArrowClick(e, -50)}
          ...
          <button
            class={`scrollbar-arrow scrollbar-arrow-right ${
              !props.canScrollDown ? "disabled" : ""
            }`}
            disabled={!props.canScrollDown}
            onClick={(e) => handleArrowClick(e, 50)}
