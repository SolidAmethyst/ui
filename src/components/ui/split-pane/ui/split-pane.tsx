...
export const SplitPane: Component<SplitPaneProps> = (props) => {
  ...
  return (
    <div
      ...
      style={{
        ...splitPaneStyles.container(direction()),
        ...props.style,
      }}
    >
      <div style={splitPaneStyles.panel(direction(), firstSize())}>
        {props.first}
      </div>
      <Show when={showHandle()}>
        <div
          ...
          style={{
            ...splitPaneStyles.handle(direction(), isDragging()),
            ...(isDragging()
              ? splitPaneStyles.handleDragging(direction())
              : {}),
          }}
          onMouseEnter={(e) => {
            if (!isDragging()) {
              const hoverStyles = splitPaneStyles.handleHover(direction());
      ...
      <div style={splitPaneStyles.panel(direction(), secondSize())}>
        {props.second}
      </div>
    </div>
  );
