 ...
 * Supports JavaScript/TypeScript, JSX, CSS, and HTML
 */

/**
 * Highlights code syntax with HTML spans
...
export const highlightCode = (code: string): string => {
	...
	// Note: @ is not in the operator list, so CSS at-rules won't be overwritten
