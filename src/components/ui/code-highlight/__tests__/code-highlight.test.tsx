...
describe('CodeHighlight', () => {
	it('renders code block', () => {
		const { container } = render(() => (
			<CodeHighlight code='const x = 1' isDark={() => true} />
		))
	...
	it('renders copy button', () => {
		render(() => <CodeHighlight code='test code' isDark={() => true} />)
	...
	it('highlights strings', () => {
		const { container } = render(() => (
			<CodeHighlight code='const str = "hello"' isDark={() => true} />
		))
	...
	it('highlights comments', () => {
		const { container } = render(() => (
			<CodeHighlight code='// This is a comment' isDark={() => true} />
		))
	...
	it('highlights JSX tags', () => {
		const { container } = render(() => (
			<CodeHighlight code='<div>Hello</div>' isDark={() => true} />
		))
	...
	it('applies dark theme styles', () => {
		const { container } = render(() => (
			<CodeHighlight code='test' isDark={() => true} />
		))
	...
	it('applies light theme styles', () => {
		const { container } = render(() => (
			<CodeHighlight code='test' isDark={() => false} />
		))
	...
	it('accepts custom class name', () => {
		const { container } = render(() => (
			<CodeHighlight code='test' isDark={() => true} class='custom-class' />
		))
	...
	it('highlights CSS at-rules', () => {
		const { container } = render(() => (
			<CodeHighlight code='@layer base {}' isDark={() => true} />
		))
	...
	it('highlights CSS selectors', () => {
		const { container } = render(() => (
			<CodeHighlight code=':root { color: red; }' isDark={() => true} />
		))
	...
	it('highlights CSS custom properties', () => {
		const { container } = render(() => (
			<CodeHighlight code='--primary-color: blue;' isDark={() => true} />
		))
	...
	it('handles empty code', () => {
		render(() => <CodeHighlight code='' isDark={() => true} />)
...
const z = x + y`
		...
		const { container } = render(() => (
			<CodeHighlight code={code} isDark={() => true} />
		))
