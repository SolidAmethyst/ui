...
describe("CheckboxTree", () => {
  it("renders tree nodes", () => {
    render(() => <CheckboxTree nodes={mockTree} />);
  ...
  it("calls onChange when node is clicked", () => {
    ...
    render(() => <CheckboxTree nodes={mockTree} onChange={onChange} />);
  ...
  it("calls onTreeChange when any node changes", () => {
    ...
    render(() => <CheckboxTree nodes={mockTree} onTreeChange={onTreeChange} />);
  ...
  it("handles disabled nodes", () => {
    ...
    render(() => <CheckboxTree nodes={disabledTree} />);
  ...
  it("applies custom class name", () => {
    render(() => <CheckboxTree nodes={mockTree} class="custom-tree" />);
