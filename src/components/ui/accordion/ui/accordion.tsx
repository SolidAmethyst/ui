        ...
        {(item) => {
          ...
          return (
            <div style={accordionStyles.item()}>
              <div
                ...
                onMouseEnter={(e) => {
                  if (!(item.disabled ?? false)) {
                    const hoverStyles = accordionStyles.headerHover(
                      item.disabled ?? false,
                    );
              ...
              >
                <div style={accordionStyles.headerContent()}>{item.header}</div>
                <span
                  class="material-symbols-rounded"
                  style={accordionStyles.icon(expanded())}
                >
                  expand_more
                </span>
              </div>
              <div
                style={accordionStyles.content(expanded())}
                role="region"
