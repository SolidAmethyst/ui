 ...
 */
export const hoverContainerStyles = (backgroundOpacity?: number): JSX.CSSProperties => ({
 ...
 */
export const hoverInteractiveStyles = (
	options?: {
	...
	if (options?.backgroundOpacity !== undefined) {
		styles['background-color'] = `hsla(var(--primary-hover) / ${options.backgroundOpacity})`
	}
