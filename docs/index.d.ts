...
export declare interface ScrollbarPhysicsConfig {
    thumbSize: number;
    trackSize: number;
    contentSize: number;
    friction: number;
...
export declare interface ScrollbarPhysicsState {
    position: number;
    velocity: number;
    acceleration: number;
}
...
export declare interface UIEngineWithDLL extends UIEngine {
    calculateScrollbarPhysics(config: ScrollbarPhysicsConfig, currentState: ScrollbarPhysicsState, targetPosition: number, deltaTime: number): Promise<ScrollbarPhysicsState>;
    getPhysicsEngineInfo(): Promise<string>;
}
...
export declare function useScrollbarLogic(state: Accessor<ScrollbarState>, setState: Setter<ScrollbarState>, direction: () => string, containerRef: () => HTMLDivElement | undefined, contentRef: () => HTMLDivElement | undefined, trackRef: () => HTMLDivElement | undefined, minThumbSize: () => number): {
